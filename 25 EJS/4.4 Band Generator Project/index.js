...
app.post("/submit", (req, res) => {
  ...
  var randomNum1 = Math.floor(Math.random()*adj.length)-1;  
  var randomNum2 = Math.floor(Math.random()*noun.length)-1;
  var randomAdj = adj[randomNum1]; 
  var randomNoun = noun[randomNum2];
